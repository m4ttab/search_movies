...
class DirectorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create director" do
    assert_difference('Director.count') do
      post directors_url, params: { director: { date_of_birth: @director.date_of_birth, description: @director.description, film_id: @director.film_id, name: @director.name, place_of_birth: @director.place_of_birth } }
    end
  ...
  test "should update director" do
    patch director_url(@director), params: { director: { date_of_birth: @director.date_of_birth, description: @director.description, film_id: @director.film_id, name: @director.name, place_of_birth: @director.place_of_birth } }
